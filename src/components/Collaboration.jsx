    ...
    <Section crosses>
      <div className='container lg:flex'>
        ...
        <div className='lg:ml-auto xl:w-[38rem] mt-4'>
          <p className="body-2 mb-2 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto">
            {collabText}
          </p>
          ...
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
            ...
            {collabApps.map((app, index) => (
                <li key={app.id} className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem] origin-bottom rotate-${index * 45}`}>
                   <div className={`relative -top-[1.6rem] flex w-[3.2rem] bg-n-7 border border-n-1/15 rounded-xl -rotate-${index * 45}`}>
                     <img src={app.icon} className='m-auto' width={app.width} height={app.height} alt={app.title}/>
                   </div>
                </li>
            ))}
          </ul>
