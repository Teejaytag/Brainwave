  ...
  return (
    <Section  className='pt-[12rem] -mt-[5.25rem] crosses crossesOffset="lg:translate-y-[5.25rem]" customPaddings id="hero"'>
        <div className='container relative' ref={parallaxRef}>
            <div className='relative z-1 max-w-[62rem] mx-auto text-center mt-[5rem] mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]'>
            ...
            <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
                ...
                <div className="absolute -top-[54%] left-1/2 w-[234]">
                  <img src={heroBackground} className="w-full" height={1440} width={1800} alt="hero" />
                </div>
